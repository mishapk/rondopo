unit md5hash;
interface
uses Windows, Messages, SysUtils, Graphics, Classes, StdCtrls, Registry;

Function md5(s:ansistring):ansistring;
function IsWin2k: boolean;
function BIOSInfo(OS : ansistring):ansistring;
function GetHardID:ansistring;
 function ProductID: ansistring;
  function C(Text : ansistring):ansistring;
implementation
function ProductID: ansistring;
var Reg:TRegistry;
begin
...
('HARDWARE\DESCRIPTION\System')
        then result := Readstring('SystemBiosDate')
    finally Free;
    end;
  end
  else try
