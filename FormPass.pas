...
begin
  ...
  begin
    ...
    MessageDlg('Вы ввели неправильный пароль!', mtError, [mbOK], 0, mbNo);
  end;
...
begin
  ...
  if (MaskEdit1.Text = s) then
   ...
   avto:=false;
   FormPassword.res := true;
   FormMain.ADDtoArchive(FormMain._MKU,'1092','-100','Вход пользователя: '+ADOQuery1.Fields.FieldByName('UserName').AsString);
     Close;
    end
  else
  begin
